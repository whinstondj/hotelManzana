//
//  ConsultRegisterTableViewController.swift
//  hotelManzana
//
//  Created by Winston Castillo on 6/12/18.
//  Copyright © 2018 Winston Castillo. All rights reserved.
//

import UIKit

class ConsultRegisterTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let registration = registration {
            ...
            adults.text = String(registration.numberOfAdults)
            children.text = String(registration.numberOfChildren)
        }
